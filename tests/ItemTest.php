...
final class ItemTest extends StructuredFieldTestCase
{
    ...
    public function it_will_fail_if_the_default_value_is_invalid_for_the_parameter_name(): void
    {
        ...
        $item->parameterByKey('b', default:'bébé');
    }
    ...
    public function it_can_validate_and_trigger_a_default_error_message_for_parameters_by_indices(): void
    {
        ...
        $this->expectExceptionObject(new Violation("The parameter at position '0' whose key is 'a' with the value '?1' failed validation."));
